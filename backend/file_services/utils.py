...
# Add this function at the end of your utils.py file

def delete_user_from_cognito(username: str):
    """
    ...
    try:
        ...
        logger.warning(f"User '{username}' not found in Cognito; already deleted?")
        # Not an error, the user is already gone.
        pass
    except Exception as e:
        logger.exception(f"Failed to delete user '{username}' from Cognito: {e}")
